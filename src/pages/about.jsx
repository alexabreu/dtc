...
export default () => (
  ...
  >
    ...
    <h4>What happens once I complete the first part of my treatment at Downeast Treatment Center?</h4>
    ...
    <h4>What happens if I need more support once I have transitioned my care away from the Downeast Treatment Center?</h4>
